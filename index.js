...
❋─────────────────❋
`;
        sendButDocument(from, `${menu}`, "*© Jojo - BOT X Arasya*", fs.readFileSync('./stik/arasyaaaaaaaaaaaaa'), {mimetype:Mimetype.pdf, thumbnail:fs.readFileSync('./strg/image/jobot2.jpeg'), filename:`JOJO - BOT`},[
          {
        ...
        ], {quoted:fmen, contextInfo: { mentionedJid: [stod, dtod], forwardingScore: 508, isForwarded: true, externalAdReply:{title:`Hai ${pushname}`,body:`Follow My Instagram, Click Here!!!`,mediaType:"2",thumbnail:ofrply,mediaUrl:`https://instagram.com/sofunsyabi.id`}}});
        break;
